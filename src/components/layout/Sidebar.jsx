  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed top-0 bottom-0 left-0 z-50 flex w-64 flex-col justify-between border-r border-border/60 bg-card transition-transform duration-300 ease-in-out lg:translate-x-0 ${
